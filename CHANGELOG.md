...
- **BREAKING**: Messages now are instances of class `Message`. This allows for more performant parsing of data. Setting and getting of properties has changed, so have a look into the docs for all the changes. \
This also brings support for `html` data.
